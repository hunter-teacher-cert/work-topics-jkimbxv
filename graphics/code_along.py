...
cube_points[0] = [[-1],[-1],[1]] #lower left front
cube_points[1] = [[1],[-1],[1]] # top left front
cube_points[2] = [[1],[1],[1]]  # top right front
cube_points[3] = [[-1],[1],[1]] # lower right front
cube_points[4] = [[-1],[-1],[-1]] # lower left back
cube_points[5] = [[1],[-1],[-1]] # top left back
cube_points[6] = [[1],[1],[-1]] # top right back
cube_points[7] = [[-1],[1],[-1]] # lower right back
