...
transaction1  = newBlockChain.new_transaction("z","jiyoon","1")

# STEP 4 add the new block to the chain using the new_block() by passing a proof argument for each
newBlockChain.new_block(101)

# STEP 5 Print the chain with the new changes
print(newBlockChain)

# STEP 6 Repeat steps 3-5 to record two more transactions
transaction2  = newBlockChain.new_transaction("jeffbezos","jiyoon","10000000")
newBlockChain.new_block(102)
print(newBlockChain)

transaction2  = newBlockChain.new_transaction("markzucks","jiyoon","100000")
newBlockChain.new_block(103)
print(newBlockChain)
